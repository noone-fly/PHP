...
public class GetRequestActivity extends AppCompatActivity {
    ...
    String requestUrl = "https://api.agora.io/dev/v1/project/?id=<appID>&name=<projectName>";
    ...
    String encoding = Base64.encodeToString("<CustomerID>:<CustomerCertificate>".getBytes(Charset.forName("utf-8")), Base64.NO_WRAP);
